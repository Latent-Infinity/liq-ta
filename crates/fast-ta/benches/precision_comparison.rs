//! Precision mode comparison benchmarks for fast-ta indicators.
//!
//! Run with: `cargo bench -p fast-ta --bench precision_comparison`
//!
...
criterion_main!(simple_benches, variance_benches, cumulative_benches, wilder_benches);
