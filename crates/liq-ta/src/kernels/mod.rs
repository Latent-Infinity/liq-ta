...
// needing to specify the submodule, e.g., `use liq_ta::kernels::rolling_max;`
...
pub use rolling_extrema::{
    MonotonicDeque, RollingExtremaOutput, compute_stochastic_fast_vhgw_f32,
    compute_stochastic_fast_vhgw_f64, compute_stochastic_full_vhgw_f32,
    compute_stochastic_full_vhgw_f64, rolling_extrema, rolling_extrema_fused_vhgw,
    rolling_extrema_into, rolling_extrema_lookback, rolling_extrema_min_len, rolling_max,
    rolling_max_into, rolling_max_nan_propagating, rolling_midpoint_vhgw_f64, rolling_min,
    rolling_min_into, rolling_min_nan_propagating,
};
