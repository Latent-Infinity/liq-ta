...
//!
//! ```
//! use liq_ta::indicators::stochastic::{stochastic, StochasticOutput};
//!
...
///
/// ```
/// use liq_ta::indicators::stochastic::stochastic;
///
...
///
/// ```
/// use liq_ta::indicators::stochastic::stochastic_k_lookback;
///
...
pub const fn stochastic_k_lookback(k_period: usize) -> usize {
    if k_period == 0 { 0 } else { k_period - 1 }
}
...
///
/// ```
/// use liq_ta::indicators::stochastic::stochastic_d_lookback;
///
...
///
/// ```
/// use liq_ta::indicators::stochastic::stochastic_min_len;
///
...
///
/// ```
/// use liq_ta::indicators::stochastic::stochastic_fast;
///
...
///
/// ```
/// use liq_ta::indicators::stochastic::stochastic_slow;
///
...
///
/// ```
/// use liq_ta::indicators::stochastic::stochastic_full;
///
/// let high = vec![44.0_f64, 44.5, 44.75, 44.25, 44.5, 44.75, 45.0, 44.5, 44.0, 44.25, 44.5];
/// let low = vec![43.5_f64, 44.0, 44.25, 43.75, 44.0, 44.25, 44.5, 44.0, 43.5, 43.75, 44.0];
/// let close = vec![43.75_f64, 44.25, 44.5, 44.0, 44.25, 44.5, 44.75, 44.25, 43.75, 44.0, 44.25];
...
fn compute_raw_k<T: SeriesElement + 'static>(
    ...
    if has_nan || is_invalid(close[first_idx]) {
        ...
        if range > T::zero() {
            output[first_idx] =
                compute_percent_k_mul_first(close[first_idx], lowest, range, hundred)?;
        } else {
    ...
    for today in k_period..n {
        ...
        let leaving_was_nan = is_invalid(high[prev_trailing]) || is_invalid(low[prev_trailing]);
