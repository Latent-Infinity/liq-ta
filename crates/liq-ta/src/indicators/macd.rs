...
//!
//! ```
//! use liq_ta::indicators::macd::{macd, MacdOutput};
//!
//! let data = vec![
...
///
/// ```
/// use liq_ta::indicators::macd::macd_line_lookback;
///
...
///
/// ```
/// use liq_ta::indicators::macd::macd_signal_lookback;
///
...
///
/// ```
/// use liq_ta::indicators::macd::macd_min_len;
///
...
///
/// ```
/// use liq_ta::indicators::macd::macd;
///
...
///
/// ```
/// use liq_ta::indicators::macd::macd_into;
///
/// let mut data: Vec<f64> = Vec::with_capacity(50);
/// for i in 0..50 {
///     data.push(100.0 + (i as f64) * 0.5);
