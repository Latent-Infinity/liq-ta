...
//!
//! ```
//! use liq_ta::indicators::ema::{ema, ema_wilder};
//!
...
///
/// ```
/// use liq_ta::indicators::ema::ema_lookback;
///
...
///
/// ```
/// use liq_ta::indicators::ema::ema_min_len;
///
...
///
/// ```
/// use liq_ta::indicators::ema::ema_into;
///
...
///
/// ```
/// use liq_ta::indicators::ema::ema_wilder;
///
...
///
/// ```
/// use liq_ta::indicators::ema::ema_with_alpha;
///
...
#[inline]
#[must_use = "this returns a Result with the EMA values, which should be used"]
pub fn ema_with_alpha<T: SeriesElement + 'static>(
    data: &[T],
    period: usize,
    alpha: T,
) -> Result<Vec<T>> {
...
fn ema_core_f64_unchecked(data: &[f64], period: usize, alpha: f64, output: &mut [f64]) {
    ...
    while i < n {
        ...
        unsafe {
            *output.get_unchecked_mut(i) = ema;
        }
        i += 1;
    }
}
...
///
/// ```
/// use liq_ta::indicators::ema::wilder_to_standard_period;
///
...
///
/// ```
/// use liq_ta::indicators::ema::standard_to_wilder_period;
///
