...
///
/// ```
/// use liq_ta::indicators::rsi::rsi_lookback;
///
...
///
/// ```
/// use liq_ta::indicators::rsi::rsi_min_len;
///
...
pub fn rsi<T: SeriesElement + 'static>(data: &[T], period: usize) -> Result<Vec<T>> {
    ...
    if TypeId::of::<T>() == TypeId::of::<f64>() {
        ...
        } // Safe: compute_rsi_core writes all elements
...
///
/// ```
/// use liq_ta::indicators::rsi::rsi_into;
///
/// let data = vec![44.0_f64, 44.5, 45.0, 44.5, 44.0, 44.5, 45.0];
