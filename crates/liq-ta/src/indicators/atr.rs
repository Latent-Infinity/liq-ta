...
//!
//! ```
//! use liq_ta::indicators::atr::{atr, true_range};
//!
...
///
/// ```
/// use liq_ta::indicators::atr::atr_lookback;
///
...
///
/// ```
/// use liq_ta::indicators::atr::atr_min_len;
///
...
///
/// ```
/// use liq_ta::indicators::atr::true_range_lookback;
///
...
///
/// ```
/// use liq_ta::indicators::atr::true_range_min_len;
///
...
///
/// ```
/// use liq_ta::indicators::atr::true_range;
///
...
pub fn true_range<T: SeriesElement + 'static>(
    high: &[T],
    low: &[T],
    close: &[T],
) -> Result<Vec<T>> {
    ...
    if TypeId::of::<T>() == TypeId::of::<f64>() {
        ...
        let out = unsafe { std::slice::from_raw_parts_mut(tr.as_mut_ptr(), n) };
...
///
/// ```
/// use liq_ta::indicators::atr::true_range_into;
///
/// let high = vec![10.0_f64, 11.0, 12.0, 11.5, 12.0];
/// let low = vec![9.0_f64, 10.0, 11.0, 10.5, 11.0];
/// let close = vec![9.5_f64, 10.5, 11.5, 11.0, 11.8];
...
///
/// ```
/// use liq_ta::indicators::atr::atr_into;
///
/// let high = vec![48.70_f64, 48.72, 48.90, 48.87, 48.82, 49.05, 49.20, 49.35, 49.92, 50.19, 50.12];
/// let low = vec![47.79_f64, 48.14, 48.39, 48.37, 48.24, 48.64, 48.94, 48.86, 49.50, 49.87, 49.20];
/// let close = vec![48.16_f64, 48.61, 48.75, 48.63, 48.74, 49.03, 49.07, 49.32, 49.91, 50.13, 49.53];
