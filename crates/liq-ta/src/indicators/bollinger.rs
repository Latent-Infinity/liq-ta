...
//!
//! ```
//! use liq_ta::indicators::bollinger::{bollinger, BollingerOutput};
//!
...
#[inline]
fn compute_initial_sums<T: SeriesElement + 'static>(data: &[T], period: usize) -> (T, T, usize) {
    use std::any::TypeId;
...
///
/// ```
/// use liq_ta::indicators::bollinger::bollinger_lookback;
///
...
///
/// ```
/// use liq_ta::indicators::bollinger::bollinger_min_len;
///
...
///
/// ```
/// use liq_ta::indicators::bollinger::bollinger;
///
...
///
/// ```
/// use liq_ta::indicators::bollinger::{bollinger_into, BollingerOutput};
///
...
///
/// ```
/// use liq_ta::indicators::bollinger::rolling_stddev;
///
