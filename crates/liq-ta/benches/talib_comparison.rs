//! Performance comparison between liq-ta and TA-Lib (via FFI).
//!
//! Run with: `cargo bench -p liq-ta --bench talib_comparison`
//!
...
// TA-Lib FFI bindings
use ta_lib_sys::{
    AD, ADX, APO, AROON, ATR, BBANDS, BOP, CCI, CMO, DEMA, DX, EMA, KAMA, LINEARREG,
    LINEARREG_ANGLE, LINEARREG_INTERCEPT, LINEARREG_SLOPE, MACD, MAType, MFI, MIDPOINT, MIDPRICE,
    MOM, OBV, ROC, RSI, SMA, STDDEV, STOCH, STOCHF, T3, TEMA, TRANGE, TRIMA, TRIX, TSF, ULTOSC,
    VAR, WILLR, WMA,
};
...
use liq_ta::indicators::{
    ...
    sma::sma,
    statistics::{
        beta, correl, cov, kurt, linearreg, linearreg_angle, linearreg_intercept, linearreg_slope,
        mad, sem, skew, stddev, tsf, var, zscore,
    },
    ...
    for &size in SIZES {
        ...
        for &period in PERIODS {
            ...
            group.bench_with_input(
                BenchmarkId::new(format!("liq-ta/p{}", period), size),
                &data,
                |b, data| {
    ...
    for &size in SIZES {
        ...
        for &period in PERIODS {
            ...
            group.bench_with_input(
                ...
                &data,
                |b, data| {
                    b.iter(|| ema(black_box(data), black_box(period)));
                },
            );
    ...
    for &size in SIZES {
        ...
        for &period in PERIODS {
            ...
            group.bench_with_input(
                ...
                &data,
                |b, data| {
                    b.iter(|| wma(black_box(data), black_box(period)));
                },
            );
    ...
    for &size in SIZES {
        ...
        for &period in PERIODS {
            ...
            group.bench_with_input(
                ...
                &data,
                |b, data| {
                    b.iter(|| dema(black_box(data), black_box(period)));
                },
            );
    ...
    for &size in SIZES {
        ...
        for &period in PERIODS {
            ...
            group.bench_with_input(
                ...
                &data,
                |b, data| {
                    b.iter(|| tema(black_box(data), black_box(period)));
                },
            );
    ...
    for &size in SIZES {
        ...
        for &period in PERIODS {
            ...
            group.bench_with_input(
                ...
                &data,
                |b, data| {
                    b.iter(|| trima(black_box(data), black_box(period)));
                },
            );
    ...
    for &size in SIZES {
        ...
        for &period in PERIODS {
            ...
            group.bench_with_input(
                ...
                &data,
                |b, data| {
                    b.iter(|| kama(black_box(data), black_box(period)));
                },
            );
    ...
    for &size in SIZES {
        ...
        for &period in PERIODS {
            ...
            group.bench_with_input(
                ...
                &data,
                |b, data| {
                    b.iter(|| t3(black_box(data), black_box(period)));
                },
            );
    ...
    for &size in SIZES {
        ...
        for &period in PERIODS {
            ...
            group.bench_with_input(
                ...
                &data,
                |b, data| {
                    b.iter(|| rsi(black_box(data), black_box(period)));
                },
            );
    ...
    for &size in SIZES {
        ...
        for &period in PERIODS {
            ...
            group.bench_with_input(
                ...
                |b, data| {
                    b.iter(|| {
                        mom_into(black_box(data), black_box(period), black_box(&mut output))
                            .unwrap()
                    });
                },
            );
    ...
    for &size in SIZES {
        ...
        for &period in PERIODS {
            ...
            group.bench_with_input(
                ...
                &data,
                |b, data| {
                    b.iter(|| roc(black_box(data), black_box(period)));
                },
            );
    ...
    for &size in SIZES {
        ...
        for &period in PERIODS {
            ...
            group.bench_with_input(
                ...
                &data,
                |b, data| {
                    b.iter(|| trix(black_box(data), black_box(period)));
                },
            );
    ...
    for &size in SIZES {
        ...
        for &period in PERIODS {
            ...
            group.bench_with_input(
                ...
                &data,
                |b, data| {
                    b.iter(|| bollinger(black_box(data), black_box(period), black_box(num_std)));
                },
            );
...
fn bench_obv(c: &mut Criterion) {
    ...
    for &size in SIZES {
        ...
        group.bench_with_input(
            ...
            &(&close, &volume),
            |b, (c, v)| {
                b.iter(|| obv_into(black_box(*c), black_box(*v), black_box(&mut output)).unwrap());
            },
        );
    ...
    for &size in SIZES {
        ...
        for &period in PERIODS {
            ...
            group.bench_with_input(
                ...
                &data,
                |b, data| {
                    b.iter(|| stddev(black_box(data), black_box(period)));
                },
            );
    ...
    for &size in SIZES {
        ...
        for &period in PERIODS {
            group.bench_with_input(
                ...
                &data,
                |b, data| {
                    b.iter(|| zscore(black_box(data), black_box(period)));
                },
            );
        }
    }
    ...
    for &size in SIZES {
        ...
        for &period in PERIODS {
            group.bench_with_input(
                ...
                &data,
                |b, data| {
                    b.iter(|| sem(black_box(data), black_box(period)));
                },
            );
        }
    }
    ...
    for &size in SIZES {
        ...
        for &period in PERIODS {
            group.bench_with_input(
                ...
                &data,
                |b, data| {
                    b.iter(|| mad(black_box(data), black_box(period)));
                },
            );
        }
    }
    ...
    for &size in SIZES {
        ...
        for &period in PERIODS {
            group.bench_with_input(
                ...
                &data,
                |b, data| {
                    b.iter(|| skew(black_box(data), black_box(period)));
                },
            );
        }
    }
    ...
    for &size in SIZES {
        ...
        for &period in PERIODS {
            group.bench_with_input(
                ...
                &data,
                |b, data| {
                    b.iter(|| kurt(black_box(data), black_box(period)));
                },
            );
        }
    }
    ...
    for &size in SIZES {
        ...
        for &period in PERIODS {
            group.bench_with_input(
                ...
                &(&data0, &data1),
                |b, (d0, d1)| {
                    b.iter(|| cov(black_box(d0), black_box(d1), black_box(period)));
                },
            );
        }
    }
    ...
    for &size in SIZES {
        ...
        for &period in PERIODS {
            group.bench_with_input(
                ...
                &(&data0, &data1),
                |b, (d0, d1)| {
                    b.iter(|| correl(black_box(d0), black_box(d1), black_box(period)));
                },
            );
        }
    }
    ...
    for &size in SIZES {
        ...
        for &period in PERIODS {
            group.bench_with_input(
                ...
                &(&data0, &data1),
                |b, (d0, d1)| {
                    b.iter(|| beta(black_box(d0), black_box(d1), black_box(period)));
                },
            );
        }
    }
    ...
    for &size in SIZES {
        ...
        for &period in PERIODS {
            ...
            group.bench_with_input(
                ...
                &data,
                |b, data| {
                    b.iter(|| linearreg(black_box(data), black_box(period)));
                },
            );
    ...
    for &size in SIZES {
        ...
        for &period in PERIODS {
            ...
            group.bench_with_input(
                ...
                &data,
                |b, data| {
                    b.iter(|| tsf(black_box(data), black_box(period)));
                },
            );
    ...
    for &size in SIZES {
        ...
        for &period in PERIODS {
            ...
            group.bench_with_input(
                ...
                &data,
                |b, data| {
                    b.iter(|| linearreg_slope(black_box(data), black_box(period)));
                },
            );
    ...
    for &size in SIZES {
        ...
        for &period in PERIODS {
            ...
            group.bench_with_input(
                ...
                &data,
                |b, data| {
                    b.iter(|| linearreg_intercept(black_box(data), black_box(period)));
                },
            );
    ...
    for &size in SIZES {
        ...
        for &period in PERIODS {
            ...
            group.bench_with_input(
                ...
                &data,
                |b, data| {
                    b.iter(|| linearreg_angle(black_box(data), black_box(period)));
                },
            );
    ...
    for &size in SIZES {
        ...
        for &period in PERIODS {
            ...
            group.bench_with_input(
                ...
                &data,
                |b, data| {
                    b.iter(|| midpoint(black_box(data), black_box(period)));
                },
            );
    ...
    for &size in SIZES {
        ...
        for &period in PERIODS {
            ...
            group.bench_with_input(
                ...
                &(&high, &low),
                |b, (h, l)| {
                    b.iter(|| midprice(black_box(*h), black_box(*l), black_box(period)));
                },
            );
...
criterion_group!(
    momentum, bench_rsi, bench_macd, bench_mom, bench_roc, bench_apo, bench_trix,
);
...
criterion_group!(volatility, bench_atr, bench_trange, bench_bollinger,);
